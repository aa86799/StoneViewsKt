...
import com.stone.stoneviewskt.databinding.ItemSimpleList3Binding
 ...
 * time:    2020/4/4 11:14
 */
class SampleAdapter3(private val list: List<String>? = listOf(), private val itemClick: (Int, String)-> Unit): RecyclerView.Adapter<BaseBindingViewHolder>() {
...
//        return BaseViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_simple_list3, parent, false))
        return BaseBindingViewHolder(inflate<ItemSimpleList3Binding>(parent))
    }
    ...
    override fun onBindViewHolder(holder: BaseBindingViewHolder, position: Int) {
        val bind = holder.mBind as ItemSimpleList3Binding
