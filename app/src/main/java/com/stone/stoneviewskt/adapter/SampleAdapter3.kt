 ...
 * time:    2020/4/4 11:14
 */
class SampleAdapter3(private val list: List<String>? = listOf(), private val itemClick: (Int, String)-> Unit): RecyclerView.Adapter<BaseViewHolder>() {
...
//        return BaseViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_simple_list3, parent, false))
        return BaseViewHolder(inflate<ItemSimpleList3Binding>(parent))
    }
